<tr class="text-left text-slate-900">
    <td class="pl-6 py-4 pr-3 font-medium">{{ $course->starting_hole }}</td>
    <td class="pl-4 py-4 text-left text-slate-500 hidden sm:table-cell">{{ $course->tee_time }}</td>
    <td class="pl-4 py-4 text-left text-slate-500 hidden sm:table-cell">{{ $course->comment }}</td>
                    ...
                    <x-dialog.panel>
                        <form wire:submit="save" class="flex flex-col gap-4">
                            ...
                            <label class="flex flex-col gap-2">
                                <div class="text-center min-w-full bg-blue-500 text-white text-2xl align-middle">Card Name</div>
                ...
                <x-dialog>
                    ...
                    <x-dialog.panel>
                        <div class="flex flex-col gap-6" x-data="{ confirmation: '' }">
                            ...
                            <h2 class="text-lg text-slate-700">This operation is permanent and can be reversed. This post will be deleted forever.</h2>
